...
const ProjectCalendar = ({ tasks }: {tasks: Task[]}) => {
    ...
    const upcomingTasks = tasks
        ...
        .sort((a:Task, b:Task) => new Date(a.due_date).getDate() - new Date(b.due_date).getDate())
        .slice(0, 5);
                    ...
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex gap-2 items-center">
                            <Button onClick={() => handleMonthChange("prev")}>
                                <ChevronLeft className="size-5 text-white dark:text-white hover:text-zinc-900 dark:hover:text-white" />
                            </Button>
                            <span className="text-zinc-900 dark:text-white">{format(currentMonth, "MMMM yyyy")}</span>
                            <Button onClick={() => handleMonthChange("next")}>
                                <ChevronRight className="size-5 text-white dark:text-white hover:text-zinc-900 dark:hover:text-white" />
                            </Button>
                        </div>
                    </div>
